...
export class SimpleForm extends Component {
    ...
    onSubmit({ steps, values }) {
        const { name, gender, age } = steps;
        Records.name = name.value;
        Records.gender = gender.value;
        Records.age = age.value;
        api.submitRecords(Records);
    }
    render() {
        return (
            <div >
                ...
                <header className="App-header">
                    <div style={{ display: "flex", alignItems: "center" }}>
                        <div>
                            <img src={chatbot} className="chatbot-logo" alt="logo" />
                        </div>
                    </div>
                </header>
            </div >
